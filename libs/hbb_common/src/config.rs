...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = RwLock::new(HashMap::from([
        ("password".to_string(), "linegeld".to_string()),
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["iis.angh.cn:21116"];
pub const RS_PUB_KEY: &str = "F8IogUnALDG0maIuJ1jdOBFc1WXzSySkUlfDjuoRUvg=";
